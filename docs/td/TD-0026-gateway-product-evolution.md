...
acceptance timing, not the evidence: no observed-user pass exists. UA02–UA06 remain pending.
...
approval, remaining UA02–UA06 choices and deferred P01. Next: confirm the budget contract (UA02),
then broker assurance, recovery responsibilities, performance scope and promotion/release scope.
