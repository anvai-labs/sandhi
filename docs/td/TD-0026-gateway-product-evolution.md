...
required before deployment (P03). UA05–UA06 remain pending.
...
broker evidence (UA03) and operator-controlled recovery (UA04), remaining UA05–UA06 choices and
deferred P01–P03. Next: confirm performance scope (UA05), then promotion/release scope.
