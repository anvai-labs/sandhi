...
| C01g | Release safeguards and accepted engineering scope; branch `docs/m1-release-acceptance` | 202 safeguard tests passed; isolated local binary smoke passed; independent scoped review clean; [SG01–SG08 tracker](../product/release-safeguards.md) | [PR #237](https://github.com/anvai-labs/sandhi/pull/237) open; public CI pending | Pending | No; remote controls and execution gate open |
