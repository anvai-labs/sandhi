...
records completed Sandhi evidence synchronization through #263/#264 and tracks the reviewed
InferFlux v0.3.0 packaging correction and focused Victor v0.9.5 approval, CI, promotion and
publication gates. The broader Victor v0.10.0 develop scope is not part of the selected release.
