...
| What must be hardened before the milestone release? | [Release safeguards](product/release-safeguards.md); tracked authorization, packaging, verification and publisher-control gaps |
