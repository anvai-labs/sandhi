...
| [0026](td/TD-0026-gateway-product-evolution.md) | In progress | W05b opt-in diagnostics shipped; W05c owned/frozen-observation settlement plus single-file tracked terminal bridge plus owned admission/dispatch handoff and W05d admission-intent/immutable-terminal-usage/bounded-recovery-inventory/opt-in dispatch-fence storage foundations implemented; authoritative proxy integration, observation amendment, recovery/export and P01–P03 remain open |
