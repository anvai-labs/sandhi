...
| [0028](td/TD-0028-cache-accounting-availability.md) | In progress | C1–C4 merged; new actual-member preserved-runtime replay and C4 joins verified; updated-runtime/lifecycle/mixed-team C5 gates remain open |
