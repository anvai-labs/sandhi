...
| What must be hardened before the milestone release? | [Release safeguards](product/release-safeguards.md); core safeguards integrated, ref controls verified (SG06), crates OIDC migration in progress and registry authority closure pending (SG07) |
