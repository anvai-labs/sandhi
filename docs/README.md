...
| What must be hardened before the milestone release? | [Release safeguards](product/release-safeguards.md); crates OIDC integrated with green pre/post-merge CI, ref controls verified (SG06), registry authority closure pending (SG07) |
