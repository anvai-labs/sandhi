...
//!
//! Scope: this is the adapter-layer primitive. It returns raw, source-measured usage; assembling a
//! neutral [`sandhi_core::event::UsageEvent`] (attribution + sink) and a metered decorator are
//! follow-on layers, mirroring how the chat adapters return [`crate::ParsedUsage`] and leave event
//! assembly to the typed runtime / `MeteredProvider`.
